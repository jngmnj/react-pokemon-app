// To parse this data:
//
//   import { Convert, PokemonDescription } from "./file";
//
//   const pokemonDescription = Convert.toPokemonDescription(json);
//
...
export class Convert {
  public static toPokemonDescription(json: string): PokemonDescription {
    return cast(JSON.parse(json), r("PokemonDescription"));
  }

  public static pokemonDescriptionToJson(value: PokemonDescription): string {
    return JSON.stringify(uncast(value, r("PokemonDescription")), null, 2);
  }
}
