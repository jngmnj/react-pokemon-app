// To parse this data:
//
//   import { Convert, FormattedPokemonData } from "./file";
//
//   const welcome = Convert.toFormattedPokemonData(json);
//
...
export class Convert {
  public static toFormattedPokemonData(json: string): FormattedPokemonData {
    return cast(JSON.parse(json), r("FormattedPokemonData"));
  }

  public static welcomeToJson(value: FormattedPokemonData): string {
    return JSON.stringify(uncast(value, r("FormattedPokemonData")), null, 2);
  }
}
...
const typeMap: any = {
  FormattedPokemonData: o(
    [
      ...
      {
        json: "DamageRelations",
        js: "DamageRelations",
        typ: a(r("DamageRelation")),
      },
