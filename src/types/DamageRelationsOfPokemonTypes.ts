// To parse this data:
//
//   import { Convert, DamageRelations } from "./file";
//
//   const damageRelations = Convert.toDamageRelations(json);
//
...
export class Convert {
  public static toDamageRelations(json: string): DamageRelationsOfPokemonTypes {
    return cast(JSON.parse(json), r("DamageRelationsOfPokemonTypes"));
  }

  public static damageRelationsToJson(
    value: DamageRelationsOfPokemonTypes
  ): string {
    return JSON.stringify(
      uncast(value, r("DamageRelationsOfPokemonTypes")),
      null,
      2
    );
  }
  ...
  DamageRelations: o(
    [
      ...
      { json: "names", js: "names", typ: a(r("Name")) },
      {
        ...
        typ: a(r("PastDamageRelation")),
      },
      { json: "pokemon", js: "pokemon", typ: a(r("Pokemon")) },
    ],
    false
  ),
  DamageRelationsClass: o(
    [
      {
